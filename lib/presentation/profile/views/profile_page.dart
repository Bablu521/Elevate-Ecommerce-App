...
class _ProfilePageState extends State<ProfilePage> {
 ...
 child:   BlocBuilder<ProfileViewModel,ProfileStates>(
         builder: (context, state) {
           if (state.profileListIsLoading){
             return const Center(
               child: CircularProgressIndicator(),
             );
           }
           else if(
                state.profileListErrorMessage != null
               ){
             return Center(
                 child: Column(
             ...
             children: [
               Padding(
                ...
                child: Column(children: [
                  ...
                  Row(
                    children: [
                      ImageIcon(const AssetImage("assets/icons/Vector.png"),size: 20,color: AppColors.mainColor,),
                      Text(AppLocalizations.of(context).flowery,style:
                        TextStyle(height: 2,fontWeight: FontWeight.normal,
                  ...
                  const SizedBox(height: 8,),
                   Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                    Text("${state.profileListSuccess?.user?.firstName}",style: const TextStyle(fontWeight: FontWeight.bold,
                        fontFamily:"Inter" ),),
                  ],),
                  const SizedBox(height: 8,),
                    Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("${state.profileListSuccess?.user?.email}",style:
                      const TextStyle(fontWeight: FontWeight.normal,
                          fontFamily:"Inter" ,color: AppColors.gray),),
                    ],),
                  const SizedBox(height: 32,),

                  ProfileRow(
                      icon1:ImageIcon(const AssetImage("assets/icons/Transaction-order (交易清单).png"),color: AppColors.black,) ,
                      text:AppLocalizations.of(context).myOrders ,icon2:const Icon( Icons.arrow_forward_ios_outlined)),
                  const SizedBox(height: 16,),
                  ProfileRow(icon1: Icon(Icons.location_on_outlined,color: AppColors.black,),
                   ...
                   children: [
                     ...
                     child: Column(
                       children: [
                         Row(
                           children: [
                             ImageIcon(const AssetImage("assets/icons/ax_vector.png"),size: 20,
                               color: AppColors.black,),
                             Text(AppLocalizations.of(context).language,style: Theme.of(context).textTheme.bodyMedium,)
                             ,const Spacer(),
                             Text(AppLocalizations.of(context).english,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                               color: AppColors.mainColor
                             ),),
                           ],
                         ),
                         const SizedBox(height: 16,),
                         Row(children: [
                           Text(AppLocalizations.of(context).aboutUs,style:  Theme.of(context).textTheme.bodyMedium,),
                           const Spacer(),
                           const Icon( Icons.arrow_forward_ios_outlined)
                         ...
                         const SizedBox(height: 16,),
                         Row(children: [
                           Text(AppLocalizations.of(context).termsAndConditions,style:  Theme.of(context).textTheme.bodyMedium,),
                           const Spacer(),
                           const Icon( Icons.arrow_forward_ios_outlined)
