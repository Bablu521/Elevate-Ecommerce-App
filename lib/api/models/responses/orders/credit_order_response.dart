...
part 'credit_order_response.g.dart';
...
class CreditOrderResponse {
  ...
  factory CreditOrderResponse.fromJson(Map<String, dynamic> json) {
    return _$CreditOrderResponseFromJson(json);
  }

  Map<String, dynamic> toJson() {
    return _$CreditOrderResponseToJson(this);
  }
}
